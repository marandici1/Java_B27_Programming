...
create a main method
    ...
    public static void main(String[] args) {
        ...
        String lastName = "Severin";
        String companyName = "Cydeo";
        String jobTitle = "SDET";
        char suite = 'T';
        int employeeId = 45789;
        int numberOfPto = 20;
        double salary = 1_000_000.0;
        boolean isFullTime = true;
        /* declare new variables and use concatenation */
...
/*
        ...
        System.out.println("Email = " + firstName + employeeId + "@" + companyName+".com");

        System.out.println("Benefits = " + salary + "$, " + numberOfPto  + " work from home"); */
