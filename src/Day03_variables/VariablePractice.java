...
public class VariablePractice {
    public static void main(String[] args) {
        ...
        System.out.println(20); //printing the int 20 is just int value
        // by default is int type
        System.out.println(age +1); //printing the age 10 + 1

        //byte num =200; 200; 200 is too big for byte types
        short num = 200; // declared and assigned atthe sime time
