...
public class T1_BulkMethods2 {
    public static void main(String[] args) {
       ...
       ArrayList<Integer>  nums = new ArrayList<>(Arrays.asList(4, 1, 1, 2, 3, 4, 5, 1, 4, 14, 4, 5, 123));
        ...
        System.out.println("cheking whith containsAll  "+ nums.containsAll(Arrays.asList(4, 3, 5, 1)));
        System.out.println("cheking whith containsAll  "+ nums.containsAll(Arrays.asList(4, 3, 5, 6)));
